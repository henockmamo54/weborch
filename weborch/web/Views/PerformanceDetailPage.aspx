                                        ...
                                        <table style="margin: 3px 5px; width: 100%;font-size: 1.3rem; font-family: Roboto, Arial, sans-serif;">
                                            <tr>
                                                ...
                                                <td style="padding: 0px 5px; text-align: left; vertical-align: top;">
                                                    ...
                                                    <strong><asp:Label ID="lblCommentMessage" runat="server" Text='<% #Eval("Username") %>'></asp:Label></strong><br />
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <table style="margin: 3px 5px; width: 100%;">
                                                                    <tr>
                                                                        ...
                                                                        <td style="padding: 0px 5px; text-align: left; vertical-align: top;">
                                                                            <asp:Label ID="lblCommentID" runat="server" Visible="false" Text='<%#Eval("ID") %>'></asp:Label>
                                                                            <strong><asp:Label ID="Label2" runat="server" Text='<% #Eval("Username") %>'></asp:Label></strong><br />
                    ...
                    <div class="row">
                        <ul class="list-group">
                            <asp:Repeater runat="server" ID="talbereplacingrepeater">
                                ...
                                <ItemTemplate>
                                    <li class="list-group-item shadowedPanel2 " style="border: none; font-family: Roboto, Arial, sans-serif; " >
