                                ...
                                <div class="row col-md-12">
                                    <div class="row">
                                        <asp:Repeater runat="server" ID="repeaterDetailMusicArtist">
                                            ...
                                            <ItemTemplate>
                                                <div class="col-md-3 " style="max-height: 200px; margin-top: 10px;">
...
where ID=@ID">
    ...
    <style>
        ...
        .GridViewEditRow input[type=text] {
            ...
            padding: 6px 12px;
            font-sze: 14px;
            line-height: 1 4285714 color: #555555 -align: midle;
            color: #ffffff er: 1px solid #cccc c;
            border-adus 4px;
            ebkit-box-s adow: iset 0 1x 1px rba0, 0, 0, 0 box-shadow: i set 0 1px 1p rgba(0, 0, 0, 0.05);
            -webkt-tran -color ease in-out 0.15s box-shadow ease-i-out 0.15s tran r se-in-out 0.15, se-in-o t 015s;
        }
