<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FreeBoardPage.aspx.cs" Inherits="web.Views.informationSpacePages.FreeBoardPage" %>
            ...
            <div class="row">
                ...
                <div class="col-md-10 shadowedPanel" style="height: 500px;">
                    <div style="height: 400px;">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OrchestraDBConnectionString %>" SelectCommand="SELECT ID, Title, [Content], Comment, Writer, timestamp FROM Core.FreeBoard"></asp:SqlDataSource>
                    </div>
                    <hr />
