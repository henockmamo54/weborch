...
{
    public partial class PromotionAndRecruitmentPageView : System.Web.UI.Page
    {
        PromotionAndRecruitmentLogic pl = new PromotionAndRecruitmentLogic();
        ...
        {
            PromotionAndRecruitment r = new PromotionAndRecruitment();
            ...
            if (pl.addNewInfo(r)) GridView1.DataBind();
