...
SELECT ID, EnglishName, KoreanName, [Group] FROM Core.Instrument"></asp:SqlDataSource>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">occupation:</div>
                                    <div class="col-md-6">
                                        <asp:RadioButton ID="radioOcupation_Composer" runat="server" Text="Composer" /> <br />
                                        <asp:RadioButton ID="radioOcupation_Conductor" runat="server" Text="Conductor" /> <br />
                                        <asp:RadioButton ID="radioOcupation_TeacherProfessor" runat="server" Text="Teacher/Professor"  /> <br />
                                        <asp:RadioButton ID="radioOcupation_Student" runat="server"  Text="Student" /> <br />
                                        <asp:RadioButton ID="radioOcupation_Audience" runat="server" Text="Audience"  /> <br />
                                        <asp:RadioButton ID="radioOcupation_Player" runat="server"  Text="Player" /> <br />
                                        <asp:RadioButton ID="RadioButton1_Other" runat="server"   Text="Other" />
